...
const Reply = ({topicId, dbInfo, submitReply, onReplyInput, messageLength}) => {
    return (
        <article className="br3 mv4 mw6 white center">
            <main>
            <form>
                    <div>                     
                        <label htmlFor="reply"><h1>Original post:</h1></label>
                        <div>
                        {
                            ...
                            console.log(dbInfo, topicId + 'from rply.js') 
                        }  
                        {      
                            dbInfo.map((post, id) => {
                                return (
